...
class CommitSignerSpec extends ObjectBehavior
{
    public function let(AccountId $userId, AccountLogin $login, AccountType $type, AccountAvatarUrl $avatarUrl)
    {
        $this->beConstructedWith($userId, $login, $name = 'the name', $type, $avatarUrl, $siteAdmin = false);
    }

    public function it_is_initializable()
    {
        $this->shouldHaveType(CommitSigner::class);
    }
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(CommitSigner::class);
    }
}
