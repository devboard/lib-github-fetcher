 ...
 */
class OpenPullRequestSpec extends ObjectBehavior
{
    public function let(
        PullRequestId $id,
    ...
    {
        $this->shouldHaveType(OpenPullRequest::class);
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(OpenPullRequest::class);
    }
}
