 ...
 */
class MergedPullRequestSpec extends ObjectBehavior
{
    public function let(
        PullRequestId $id,
    ...
    {
        $this->shouldHaveType(MergedPullRequest::class);
    ...
    public function it_exposes_merge_details(PullRequestMergeDetails $mergeDetails)
    {
        $this->getMergeDetails()->shouldReturn($mergeDetails);
    }
    ...
    public function it_can_be_serialized(
        ...
        $mergeDetails->serialize()->shouldBeCalled()->willReturn(
            [
                'mergedBy' => [
                    'userId'    => 1,
                    'login'     => 'value',
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(MergedPullRequest::class);
    }
}
