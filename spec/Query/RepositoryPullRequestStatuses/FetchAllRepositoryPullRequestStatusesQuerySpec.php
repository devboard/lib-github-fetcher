...
namespace spec\DevboardLib\GitHubFetcher\Query\RepositoryPullRequestStatuses;
...
use DevboardLib\GitHubFetcher\Query\RepositoryPullRequestStatuses\FetchAllRepositoryPullRequestStatusesQuery;
use PhpSpec\ObjectBehavior;

class FetchAllRepositoryPullRequestStatusesQuerySpec extends ObjectBehavior
{
    public function let(RepoFullName $fullName, InstallationId $installationId, UserId $userId)
    {
        $this->beConstructedWith($fullName, $installationId, $userId, $cursor = null);
    }

    public function it_is_initializable()
    {
        $this->shouldHaveType(FetchAllRepositoryPullRequestStatusesQuery::class);
    ...
    public function it_can_be_deserialized_from_queue_data()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(FetchAllRepositoryPullRequestStatusesQuery::class);
    }
}
