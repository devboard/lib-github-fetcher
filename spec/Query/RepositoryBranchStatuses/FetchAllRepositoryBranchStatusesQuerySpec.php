...
namespace spec\DevboardLib\GitHubFetcher\Query\RepositoryBranchStatuses;
...
use DevboardLib\GitHubFetcher\Query\RepositoryBranchStatuses\FetchAllRepositoryBranchStatusesQuery;
use PhpSpec\ObjectBehavior;

class FetchAllRepositoryBranchStatusesQuerySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(FetchAllRepositoryBranchStatusesQuery::class);
    ...
    public function it_can_be_deserialized_from_queue_data()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(FetchAllRepositoryBranchStatusesQuery::class);
    }
}
