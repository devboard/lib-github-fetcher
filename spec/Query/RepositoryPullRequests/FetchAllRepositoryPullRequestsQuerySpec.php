...
namespace spec\DevboardLib\GitHubFetcher\Query\RepositoryPullRequests;
...
use DevboardLib\GitHubFetcher\Query\RepositoryPullRequests\FetchAllRepositoryPullRequestsQuery;
use PhpSpec\ObjectBehavior;

class FetchAllRepositoryPullRequestsQuerySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(FetchAllRepositoryPullRequestsQuery::class);
    ...
    public function it_can_be_deserialized_from_queue_data()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(FetchAllRepositoryPullRequestsQuery::class);
    }
}
