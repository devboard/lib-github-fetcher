 ...
 * @covers \DevboardLib\GitHubFetcher\Result\RepositoryPullRequests\Payload\ClosedPullRequest
 * @group  unit
 */
class ClosedPullRequestTest extends TestCase
{
    /** @var PullRequestId */
    private $id;
    ...
    public function setUp(): void
    {
        ...
        $this->sut       = new ClosedPullRequest(
            $this->id,
            $this->number,
            $this->title,
            $this->body,
    ...
    public function testDeserialize(): void
    {
        ...
        self::assertEquals($this->sut, ClosedPullRequest::deserialize(json_decode($serialized, true)));
    }
}
