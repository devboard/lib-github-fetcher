...
use DevboardLib\GitHubFetcher\Result\RepositoryPullRequests\Payload\OpenPullRequest;
 ...
 * @covers \DevboardLib\GitHubFetcher\Result\RepositoryPullRequests\Payload\OpenPullRequest
 * @group  unit
 */
class OpenPullRequestTest extends TestCase
{
    /** @var PullRequestId */
    private $id;
    ...
    {
        $expected = [
            '__type' => 'DevboardLib\GitHubFetcher\Result\RepositoryPullRequests\Payload\OpenPullRequest',
            'id'     => 1,
            'number' => 1,
            'title'  => 'value',
            'body'   => 'value',
    ...
    public function testDeserialize(): void
    {
        ...
        self::assertEquals($this->sut, OpenPullRequest::deserialize(json_decode($serialized, true)));
    }
}
