...
namespace DevboardLib\GitHubFetcher\Query\RepositoryBranchStatuses;
...
/**
 * @see FetchAllRepositoryBranchStatusesQuerySpec
 */
class FetchAllRepositoryBranchStatusesQuery implements GitHubFetcherQuery
{
    /** @var RepoFullName */
