...
namespace DevboardLib\GitHubFetcher\Query\RepositoryPullRequests;
...
/**
 * @see FetchAllRepositoryPullRequestsQuerySpec
 */
class FetchAllRepositoryPullRequestsQuery implements GitHubFetcherQuery
{
    /** @var RepoFullName */
