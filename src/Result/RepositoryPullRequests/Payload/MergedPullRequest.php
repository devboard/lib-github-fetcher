 ...
 *
 * @see \spec\DevboardLib\GitHubFetcher\Result\RepositoryPullRequests\Payload\MergedPullRequestSpec
 * @see \Tests\DevboardLib\GitHubFetcher\Result\RepositoryPullRequests\Payload\MergedPullRequestTest
 */
class MergedPullRequest implements PullRequest
{
    /** @var PullRequestId */
    private $id;
    ...
    public function __construct(
        ...
        PullRequestMergeDetails $mergeDetails,
    ...
    public function getMergeDetails(): PullRequestMergeDetails
    {
    ...
    public function serialize(): array
    {
        ...
        return [
            ...
            'mergeDetails'   => $this->mergeDetails->serialize(),
    ...
    public static function deserialize(array $data): self
    {
        ...
        return new self(
            ...
            PullRequestMergeDetails::deserialize($data['mergeDetails']),
            PullRequestClosedAt::deserialize($data['closedAt']),
