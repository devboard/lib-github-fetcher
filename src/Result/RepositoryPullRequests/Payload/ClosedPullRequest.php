 ...
 *
 * @see \spec\DevboardLib\GitHubFetcher\Result\RepositoryPullRequests\Payload\ClosedPullRequestSpec
 * @see \Tests\DevboardLib\GitHubFetcher\Result\RepositoryPullRequests\Payload\ClosedPullRequestTest
 */
class ClosedPullRequest implements PullRequest
{
    /** @var PullRequestId */
    private $id;
